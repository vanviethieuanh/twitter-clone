function changeLocalHostName { 
    param([string]$DesiredIP = "127.0.0.1"
        , [string]$Hostname = "api.local.twitter-clone.vn"
...
changeLocalHostName 127.0.0.1 api.local.twitter-clone.vn
changeLocalHostName 127.0.0.1 portal.local.twitter-clone.vn